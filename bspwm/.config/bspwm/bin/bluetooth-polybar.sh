...
# - Service status checks without systemd
...
# Main Check Function
get_bt_status() {
    # Check bluetooth daemon state
    pidof bluetoothd >/dev/null || return 1
